    ...
    <Card className="border-dashed border-purple-200 bg-purple-50/30">
      <CardHeader>
        <CardTitle className="text-lg flex items-center gap-2">
          ...
          How Perplexity AI Enhances Your Alerts
        </CardTitle>
        <CardDescription>
          ...
          <div className="bg-white p-4 rounded-lg border border-purple-200">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-purple-900 mb-2">1. Smart Analysis</h4>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline" className="text-xs bg-blue-50 border-blue-300 text-blue-700">FDA.gov</Badge>
                  <Badge variant="outline" className="text-xs bg-green-50 border-green-300 text-green-700">USDA.gov</Badge>
                  <Badge variant="outline" className="text-xs bg-emerald-50 border-emerald-300 text-emerald-700">EPA.gov</Badge>
                  <Badge variant="outline" className="text-xs bg-gray-50 border-gray-300 text-gray-700">Official Documents</Badge>
                </div>
              </div>
            </div>
          </div>
