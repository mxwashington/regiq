-- First add the unique constraint for the ON CONFLICT clause
ALTER TABLE regulatory_data_sources 
ADD CONSTRAINT regulatory_data_sources_name_agency_key 
UNIQUE (name, agency);

-- Now add the API data sources for openFDA and FSIS
