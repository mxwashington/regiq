-- Update existing plans table and add new columns for the three-tier pricing structure
...
-- Clear old plans and add new three-tier structure
DELETE FROM public.plans;

-- Insert the three new pricing plans
INSERT INTO public.plans (plan_id, name, description, price_cents, billing_interval, monthly_price, annual_price, is_popular, sort_order, is_active) VALUES
-- Starter Plan
...
-- Clear old plan features and add new ones
