-- First create plans table and insert plans, then update plan_features

-- Create plans table if it doesn't exist to store pricing information
...
-- Insert the three new pricing plans first
