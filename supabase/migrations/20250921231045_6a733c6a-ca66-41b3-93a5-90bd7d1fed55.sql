-- RegIQ Critical Security Fixes - Corrected Version
...
-- ============================================
-- 8. PERFORMANCE OPTIMIZATION - Create indexes (corrected)
-- ============================================

-- Index for frequent subscription checks (removed immutable function)
CREATE INDEX IF NOT EXISTS idx_profiles_subscription_lookup
ON profiles(user_id, subscription_status, subscription_plan);

-- Index for trial checks (removed immutable function)
