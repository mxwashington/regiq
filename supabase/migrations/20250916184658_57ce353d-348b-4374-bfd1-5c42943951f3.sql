-- ================================================
-- FIX SECURITY DEFINER VIEWS - Remove Elevated Privileges (Fixed Dependencies)
-- ================================================

-- Drop dependent views first with CASCADE
DROP VIEW IF EXISTS security_monitoring CASCADE;
DROP VIEW IF EXISTS regiq_security_status CASCADE;
DROP VIEW IF EXISTS payment_security_audit CASCADE;
