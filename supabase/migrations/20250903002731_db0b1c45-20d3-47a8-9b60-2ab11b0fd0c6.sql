-- Fix remaining security warnings: Function Search Path Mutable (with proper trigger handling)
...
-- First, drop the trigger that depends on handle_subscription_change
...
-- Fix handle_subscription_change function (now with proper search_path)
